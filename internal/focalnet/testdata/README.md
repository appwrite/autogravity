...
pixels. It exists so Go tests can exercise the FocalNet session path without
the evaluated 19 MiB checkpoint. Do not use it for quality judgments, and do
not copy it to `models/focalnet-human.onnx` or into a Docker image.
